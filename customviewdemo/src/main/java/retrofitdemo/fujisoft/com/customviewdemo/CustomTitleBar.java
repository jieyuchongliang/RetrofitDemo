package retrofitdemo.fujisoft.com.customviewdemo;
...
public class CustomTitleBar extends RelativeLayout {
    ...
    public CustomTitleBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        View inflate = LayoutInflater.from(context).inflate(R.layout.custom_view_layout, this, true);
        titleBarLeftBtn =  inflate.findViewById(R.id.title_bar_left);
        titleBarRightBtn =  inflate.findViewById(R.id.title_bar_right);
        titleBarTitle = inflate.findViewById(R.id.title_bar_title);

        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.CustomTitleBar);
        if (attributes != null) {
            //处理titleBar背景色
            int titleBarBackGround = attributes.getResourceId(R.styleable.CustomTitleBar_title_background_color, Color.GRAY);
            ...
            if (!TextUtils.isEmpty(leftButtonText)) {
                ...
                int leftButtonDrawable = attributes.getResourceId(R.styleable.CustomTitleBar_left_button_drawable, R.drawable.ic_a);
